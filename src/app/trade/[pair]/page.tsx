...
export default function Trade() {
  ...
  const handleComfimTrade = async () => {
    ...
    const data = {
      ...
      userAddress: address?.toString(), // User's wallet or address
              ...
              {orderBookEntries
                ...
                .map((item) => (
                  <div className="justify-between flex flex-row text-sm">
                    ...
                    <h2>{item.price}</h2>
                    <div
                      className={`py-1 px-2 w-20 rounded ${
                        item.type === "buy"
                          ? "bg-[#34c38f2e] text-[#34c38f]"
                          : "bg-[#f46a6a2e] text-[#f46a6a]"
                      }`}
                    >
            ...
            <div className=" bg-[#141414] lg:h-[70vh] border-[0.5px] border-[#393939]">
              <div className="flex flex-row text-white border-b border-gray-700">
                <div
                  ...
                  className={`w-[6rem] p-4 ${
                    trade.orderType === "LONG" ? "bg-green-400" : ""
                  } cursor-pointer`}
                >
                  Long
                </div>
                ...
                <div
                  ...
                  className={`w-[6rem] p-4 ${
                    trade.orderType === "SHORT" ? "bg-red-400" : ""
                  } cursor-pointer`}
                >
                  Short
                </div>
              ...
              <div className="flex flex-col p-4 gap-4">
                <div className="flex flex-col">
                  ...
                  <span className="pt-1 ml-auto truncate w-20 text-left">
                    ${trade.contractSize * (price / 1000)}
                  </span>
                </div>
